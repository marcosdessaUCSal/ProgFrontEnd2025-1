...
function meuCodigo() {
    ...
    // limites escolhidos arbitrariamente
    const limites = {
        BEBE: 2,
        CRIANCA: 12,
        ADOLESCENTE: 18,
    ...
    const julga = (idade) => {
        ...
        switch (true) {
            case idade < limites.BEBE:
                resposta += 'é um bebê.';
                break;
            case idade < limites.CRIANCA:
                resposta += 'é uma criança.';
                break;
            case idade < limites.ADOLESCENTE:
                resposta += 'é um adolescente.';
                break;
            case idade < limites.JOVEM:
                resposta += 'é um jovem adulto.';
                break;
            case idade < limites.MEIA_IDADE:
